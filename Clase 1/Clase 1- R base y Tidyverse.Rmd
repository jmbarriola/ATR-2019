...
```
# Ambientes de trabajo y Proyectos
...
__Armado del ambiente de trabajo__

- Abrir el Rstudio o Reiniciar la sesión de R en caso de que lo tengan ya abierto (`Session --> Restart R`)
- Crear un proyecto nuevo en una carpeta (nueva o existente) de la computadora (`File --> New Project`)
- Abrir un Script y guardarlo con su nombre y apellido en la misma carpeta donde crearon el proyecto (`File --> New File --> R script`)
- Comenzar a operar sobre dicho script para resolver las siguietnes consignas:
...
- Levantar el Excel llamado CANASTAS que se encuentra en la carpeta de Fuentes, la hoja "CBT" y definirla como         - Vista en clase: __openxlsx__ 
